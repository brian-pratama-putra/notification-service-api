...
from aplikasi.dao.api.db_dao import get_notification_summary
from aplikasi.dao.api.redis_dao import cache_get


async def get_notification_summary_controller(request):
    ...
    v_hasil     = await get_notification_summary(v_user_id)
