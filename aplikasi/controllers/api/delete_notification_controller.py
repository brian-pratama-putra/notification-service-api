...
from aplikasi.dao.api.db_dao import delete_notification
from aplikasi.dao.api.redis_dao import cache_get, cache_delete
import asyncio


async def delete_notification_controller(request):
    ...
    v_hasil     = await asyncio.to_thread(delete_notification, v_notification_id, v_user_id)
